...
west twister -p qemu_cortex_m3/ti_lm3s6965 -T tests/hw_faults -v || cat /build/twister-out/qemu_cortex_m3_ti_lm3s6965/zephyr_gnu/tests/hw_faults/simulation.i2c_hardware_fault/handler.log
